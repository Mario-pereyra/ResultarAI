# attachments-security — Delta Spec (d14-attachments)

> Fuente normativa: [design/ANEXO-ATTACHMENTS.md §4](../../../../design/ANEXO-ATTACHMENTS.md) (validación §4.1, macros §4.2, prompt injection §4.3, niveles N2/N3 §4.4) y pipeline §8. Coherente con las reglas duras del proyecto (Policy Gate deny-by-default, anti prompt-injection, solo datos de prueba hacia la IA).
