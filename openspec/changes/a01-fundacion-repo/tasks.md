...
- [x] 4.2 Review final del change: consistencia docs↔specs↔código, fronteras verificadas, cero lógica de runtime introducida. Verificación: checklist del reviewer en el PR. `[modelo: opus]`
