...
## Purpose
Persistencia y deduplicación de archivos adjuntos (attachments) y sus extracciones de texto, conforme a las políticas de seguridad y retención del sistema.
