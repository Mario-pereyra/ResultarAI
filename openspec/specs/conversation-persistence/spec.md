...
## Purpose
Persistencia de sesiones, mensajes y compactación de contexto para mantener el estado del grafo conversacional y su árbol de bifurcaciones (ramas) de manera consistente.
...
- **WHEN** se persiste un sesión con sus mensajes y luego el proceso de la plataforma core se reinicia
