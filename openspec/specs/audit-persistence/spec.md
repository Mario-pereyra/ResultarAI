...
## Purpose
Persistencia y consulta del log de auditoría inmutable de la plataforma (AuditLog), garantizando la trazabilidad física completa de todas las decisiones del Policy Gate y ejecuciones de tools.
