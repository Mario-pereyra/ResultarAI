...
export default async function ShellLayout({ children }: { children: ReactNode }) {
  ...
  const labels: ShellFrameLabels = {
    ...
    topbar: {
      ...
      roleLabel,
      notificationsEmptyHint: t("topbar.notificationsEmptyHint"),
      notificationsError: t("topbar.notificationsError"),
      notificationsRetry: t("topbar.notificationsRetry"),
      notificationsMarkAllRead: t("topbar.notificationsMarkAllRead"),
      notificationsViewAll: t("topbar.notificationsViewAll"),
      notificationsView: t("topbar.notificationsView"),
      notificationsClose: t("topbar.notificationsClose"),
      notificationsKickerCuotas: t("topbar.notificationsKickerCuotas"),
      notificationsKickerSistema: t("topbar.notificationsKickerSistema"),
      notificationsKickerAprobaciones: t("topbar.notificationsKickerAprobaciones"),
    },
    gatewayError: {
